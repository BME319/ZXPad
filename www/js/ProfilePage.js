...
localStorage.setItem('DownloadAddress',"http://10.12.43.66:8011/cdmisAPP-debug.apk") ;
...
function Time() {
	...
	if (wait == 0) {
		document.getElementById("SendInvitation").disabled = false;
		document.getElementById("SendInvitation").value = "发送邀请码";
		wait = 60;

	}
	else {
		document.getElementById("SendInvitation").disabled = true;
		document.getElementById("SendInvitation").value = "重新发送邀请码(" + wait + ")";
		wait--;
