...
//									if (SetFlag2 == 0)
//									{
//										document.getElementById("alert").innerHTML = "患者信息还未保存，请返回基本信息保存患者信息！";
//										$("#popinvitation").popup("open");
//										
//									}
//								}
//							},
...
//					else 
//					{
//						document.getElementById("alert").innerHTML = "此手机号已被使用，请输入新的手机号！";
//						$("#popinvitation").popup("open");
//					}
//				},
//				error: function (msg) {
...
//		else 
//		{
//			document.getElementById("alert").innerHTML = "请输入手机号！";
//			$("#popinvitation").popup("open");
//		}
//
//
