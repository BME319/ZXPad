							  ...
							  success: function(result) {
								  if (result != "")
								  {
									  ...
									  $.ajax({
										  ...
										  timeout: 30000,
										  //contentType: "application/json;charset=utf-8",
										  url: 'http://'+ serverIP +'/'+serviceName+'/GetClassByUserId',	
										  data: { UserId: UserId},
										  dataType: 'xml',
										  async: false,
										  beforeSend: function() {},
...
function Activition() {
			...
			if (InviteCode != "")
			{
				...
				$.ajax({
					...
					timeout: 30000,
					//contentType: "application/json;charset=utf-8",
					url: 'http://'+ serverIP +'/'+serviceName+'/Activition',
					data: { UserId: UserId, InviteCode: InviteCode, revUserId: revUserId, TerminalName: TerminalName, TerminalIP: TerminalIP, DeviceType: DeviceType},
					dataType: 'xml',
					async: false,
    				beforeSend: function() {},
					success: function(result) {
											...
											success: function (result) {
												...
												if (userID != "")
												{
													$.ajax({
														...
														data: { PatientId: userID, RoleClass: "HealthCoach", Description: ""},
														dataType: 'xml',
														async: false,
														beforeSend: function() {},
														success: function (result) {
